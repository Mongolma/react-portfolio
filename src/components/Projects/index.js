...
const Projects = () => {
    return (
        <ProjectContainer id='projects'>
            ...
            <ProjectWrapper>
                <a className='paragraph'href='https://yigezu1.github.io/world-wide-travel-assistant/' target='_blank' rel="noreferrer">
                <ProjectCard>
          ...
          <a href='https://boiling-headland-62245.herokuapp.com/?id=5fffa9b7f60f5000175e8f1e' target='_blank' rel="noreferrer">
                ...
                <a href='https://mongolma.github.io/code_quiz/' target='_blank' area-label='Linkedin' rel="noreferrer">
                <ProjectCard>
